...
module.exports = function(grunt) {
    ...
    // An array of paths to third party direcotries.
    ...
    grunt.initConfig({
        ...
        eslint: {
            ...
            amd: {
              src: amdSrc,
              filter: isMoodleFile,
              options: { rules: {'no-undef': 'error', 'no-unused-vars': 'error', 'no-empty': 'error' } }
            },
    ...
    /**
     * Generate ignore files from thirdpartylibs.xml data
     */
    tasks.ignorefiles = function() {
      // Generate .eslintignore.
      var eslintIgnores = ['*/**/yui/src/*/meta/', '*/**/build/'].concat(thirdPartyPaths);
