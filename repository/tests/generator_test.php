...
class repository_generator_testcase extends advanced_testcase {
    ...
    public function test_create_type() {
        ...
        $list = array('alfresco', 'boxnet', 'coursefiles', 'dropbox', 'equella', 'filesystem', 'flickr',
        ...
        foreach ($list as $type) {
            // An exception is thrown when the repository is already enabled. Let's skip them.
        ...
        // Try to create a repository type which is already enabled.
        $this->setExpectedException('repository_exception', 'This repository already exists');
        $type = $alreadyenabled[array_rand($alreadyenabled)];
