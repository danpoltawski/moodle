 ...
 * - define('TEST_SEARCH_SOLR_COLLECTIONNAME', 'unittest');
 *
 * Optional params:
...
require_once($CFG->dirroot . '/search/tests/fixtures/mock_search_component.php');
...
class search_solr_engine_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        if (!defined('TEST_SEARCH_SOLR_HOSTNAME') || !defined('TEST_SEARCH_SOLR_COLLECTIONNAME') ||
        ...
        set_config('collectionname', TEST_SEARCH_SOLR_COLLECTIONNAME, 'search_solr');
        ...
        $this->search->add_search_component('core_mocksearch', new core_mocksearch\search\indexer());

        $this->setAdminUser();

        // Cleanup before doing anything on it as the collection it is out of this test control.
    ...
    public function test_search() {
        ...
        $this->assertEquals('the name', $results[0]->get('name'));
