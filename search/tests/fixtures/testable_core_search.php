...
class testable_core_search extends \core_search\manager {
     ...
     * @return array
     */
    public function get_components_user_accesses() {
        return parent::get_components_user_accesses();
    }

    /**
     * Adds an enabled search component to the search components list.
     *
     * @param string $componentname
     * @param \core_search\base $searchcomponent
     * @return void
     */
    public function add_search_component($componentname, \core_search\base $searchcomponent) {
       self::$enabledsearchcomponents[$componentname] = $searchcomponent;
       self::$allsearchcomponents[$componentname] = $searchcomponent;
    }
}
