...
$queryfield = optional_param('queryfield', '', PARAM_NOTAGS);
$title = optional_param('title', '', PARAM_NOTAGS);
$author = optional_param('author', '', PARAM_NOTAGS);
$component = optional_param('component', false, PARAM_COMPONENT);
...
if ($data) {
    $urlparams['queryfield'] = $data->queryfield;
    $urlparams['title'] = $data->title;
    $urlparams['author'] = $data->author;
    $urlparams['component'] = $data->component;
