...
/**
 * Search base class for components working at module level.
 *
 * @package    core_search
...
/**
 * Base implementation for components working at module level.
 *
 * Even if the component implementing search works at multiple levels,
 * if module is one of these levels it should extend this class, as
 * this class provides helper methods for module level search management.
 *
 * @package    core_search
 * @copyright  2015 David Monllao {@link http://www.davidmonllao.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
abstract class base_mod extends base {
     ...
     *
     * This can be overwriten by the search component if it works at multiple
     * levels.
     *
     * @var array
     */
