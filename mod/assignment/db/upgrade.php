...
function xmldb_assignment_upgrade($oldversion) {
    ...
    if ($oldversion < 2012050100) {
        ...
        $query       = 'FROM {assignment_submissions} s
                        ...
                        WHERE a.var4 = :var4 AND assignmenttype = :assignmenttype';

        // var4 is 'send for marking', this bug only affected when this was disabled
        $params = array('moduleid' => $moduleid, 'var4' => 0, 'assignmenttype' => 'upload');
        ...
        upgrade_mod_savepoint(true, 2012050100, 'assignment');
    }
