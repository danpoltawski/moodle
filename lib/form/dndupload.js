    ...
    var dnduploadhelper = {
        ...
        update_progress: function(filename, percent) {
            if (this.progressbars[filename] === undefined) {
                ...
                var progressouter = this.container.create('<div>'+
                '<p class="text-xs-center text-center">' + dispfilename + ':</p>'+
                '<progress class="progress" value="0" max="100"></progress>'+
                '<div class="dndupload-progress-outer">'+
            ...
            this.progressbars[filename].progressouter.one('.dndupload-progress-inner').setStyle('width', percent + '%');
            this.progressbars[filename].progressouter.one('.progress').set('value', percent);
        }
    };
