...
EOD;
    ...
    public function search_box($id = false) {
        ...
        $inputattrs = array('type' => 'text', 'name' => 'queryfield', 'placeholder' => get_string('search', 'search'),
            'size' => 13, 'tabindex' => -1, 'id' => 'id_queryfield_' . $id);
        $searchinput = html_writer::tag('form',
            html_writer::tag('label', get_string('search', 'search'), array('for' => 'id_queryfield_' . $id, 'class' => 'accesshide')) .
