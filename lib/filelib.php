...
function get_mimetypes_array() {
    static $mimearray = array (
        ...
        '3gp'  => array ('type'=>'video/quicktime', 'icon'=>'mov'),
        'aac'  => array ('type'=>'audio/aac', 'icon'=>'mp3'),
        'ai'   => array ('type'=>'application/postscript', 'icon'=>'eps'),
        ...
        'dcr'  => array ('type'=>'application/x-director', 'icon'=>'fla'),
        'dif'  => array ('type'=>'video/x-dv', 'icon'=>'mov'),
        'dir'  => array ('type'=>'application/x-director', 'icon'=>'fla'),
        'dxr'  => array ('type'=>'application/x-director', 'icon'=>'fla'),
        'eps'  => array ('type'=>'application/postscript', 'icon'=>'eps'),
        'fdf'  => array ('type'=>'application/pdf', 'icon'=>'pdf'),
        'flv'  => array ('type'=>'video/x-flv', 'icon'=>'fla'),
        'f4v'  => array ('type'=>'video/mp4', 'icon'=>'fla'),
        ...
        'jpe'  => array ('type'=>'image/jpeg', 'icon'=>'jpeg'),
        'jpeg' => array ('type'=>'image/jpeg', 'icon'=>'jpeg'),
        'jpg'  => array ('type'=>'image/jpeg', 'icon'=>'jpeg'),
        ...
        'mov'  => array ('type'=>'video/quicktime', 'icon'=>'mov'),
        'movie'=> array ('type'=>'video/x-sgi-movie', 'icon'=>'mov'),
        'm3u'  => array ('type'=>'audio/x-mpegurl', 'icon'=>'mp3'),
        'mp3'  => array ('type'=>'audio/mp3', 'icon'=>'mp3'),
        'mp4'  => array ('type'=>'video/mp4', 'icon'=>'mpeg'),
        'm4v'  => array ('type'=>'video/mp4', 'icon'=>'mpeg'),
        'm4a'  => array ('type'=>'audio/mp4', 'icon'=>'mp3'),
        'mpeg' => array ('type'=>'video/mpeg', 'icon'=>'mpeg'),
        'mpe'  => array ('type'=>'video/mpeg', 'icon'=>'mpeg'),
        'mpg'  => array ('type'=>'video/mpeg', 'icon'=>'mpeg'),

        'odt'  => array ('type'=>'application/vnd.oasis.opendocument.text', 'icon'=>'document'),
        'ott'  => array ('type'=>'application/vnd.oasis.opendocument.text-template', 'icon'=>'document'),
        'oth'  => array ('type'=>'application/vnd.oasis.opendocument.text-web', 'icon'=>'document'),
        'odm'  => array ('type'=>'application/vnd.oasis.opendocument.text-master', 'icon'=>'document'),
        ...
        'odp'  => array ('type'=>'application/vnd.oasis.opendocument.presentation', 'icon'=>'powerpoint'),
        'otp'  => array ('type'=>'application/vnd.oasis.opendocument.presentation-template', 'icon'=>'powerpoint'),
        'ods'  => array ('type'=>'application/vnd.oasis.opendocument.spreadsheet', 'icon'=>'spreadsheet'),
        'ots'  => array ('type'=>'application/vnd.oasis.opendocument.spreadsheet-template', 'icon'=>'spreadsheet'),
        'odc'  => array ('type'=>'application/vnd.oasis.opendocument.chart', 'icon'=>'spreadsheet'),
        ...
        'oga'  => array ('type'=>'audio/ogg', 'icon'=>'wma'),
        'ogg'  => array ('type'=>'audio/ogg', 'icon'=>'wma'),
        'ogv'  => array ('type'=>'video/ogg', 'icon'=>'wmv'),
        ...
        'png'  => array ('type'=>'image/png', 'icon'=>'png'),

        'pps'  => array ('type'=>'application/vnd.ms-powerpoint', 'icon'=>'pptx'),
        'ppt'  => array ('type'=>'application/vnd.ms-powerpoint', 'icon'=>'pptx'),
        ...
        'sqt'  => array ('type'=>'text/xml', 'icon'=>'text'),
        'svg'  => array ('type'=>'image/svg+xml', 'icon'=>'image'),
        'svgz' => array ('type'=>'image/svg+xml', 'icon'=>'image'),
        'swa'  => array ('type'=>'application/x-director', 'icon'=>'fla'),
        'swf'  => array ('type'=>'application/x-shockwave-flash', 'icon'=>'fla'),
        'swfl' => array ('type'=>'application/x-shockwave-flash', 'icon'=>'fla'),

        'sxw'  => array ('type'=>'application/vnd.sun.xml.writer', 'icon'=>'document'),
        'stw'  => array ('type'=>'application/vnd.sun.xml.writer.template', 'icon'=>'document'),
        'sxc'  => array ('type'=>'application/vnd.sun.xml.calc', 'icon'=>'spreadsheet'),
        'stc'  => array ('type'=>'application/vnd.sun.xml.calc.template', 'icon'=>'spreadsheet'),
        'sxd'  => array ('type'=>'application/vnd.sun.xml.draw', 'icon'=>'odt'),
        'std'  => array ('type'=>'application/vnd.sun.xml.draw.template', 'icon'=>'odt'),
        'sxi'  => array ('type'=>'application/vnd.sun.xml.impress', 'icon'=>'powerpoint'),
        'sti'  => array ('type'=>'application/vnd.sun.xml.impress.template', 'icon'=>'powerpoint'),
        'sxg'  => array ('type'=>'application/vnd.sun.xml.writer.global', 'icon'=>'document'),
        'sxm'  => array ('type'=>'application/vnd.sun.xml.math', 'icon'=>'odt'),

        'tar'  => array ('type'=>'application/x-tar', 'icon'=>'zip'),
        'tif'  => array ('type'=>'image/tiff', 'icon'=>'tiff'),
        'tiff' => array ('type'=>'image/tiff', 'icon'=>'tiff'),
        ...
        'wav'  => array ('type'=>'audio/wav', 'icon'=>'wav'),
        'webm'  => array ('type'=>'video/webm', 'icon'=>'wmv'),
        'wmv'  => array ('type'=>'video/x-ms-wmv', 'icon'=>'wmv'),
        'asf'  => array ('type'=>'video/x-ms-asf', 'icon'=>'wmv'),
        'xdp'  => array ('type'=>'application/pdf', 'icon'=>'pdf'),
        'xfd'  => array ('type'=>'application/pdf', 'icon'=>'pdf'),
        'xfdf' => array ('type'=>'application/pdf', 'icon'=>'pdf'),

        'xls'  => array ('type'=>'application/vnd.ms-excel', 'icon'=>'xlsx'),
        'xlsx' => array ('type'=>'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'icon'=>'xlsx'),
        'xlsm' => array ('type'=>'application/vnd.ms-excel.sheet.macroEnabled.12', 'icon'=>'xlsx'),
        ...
        'xml'  => array ('type'=>'application/xml', 'icon'=>'text'),
        'xsl'  => array ('type'=>'text/xml', 'icon'=>'text'),
