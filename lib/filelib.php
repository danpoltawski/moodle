...
function get_mimetypes_array() {
    static $mimearray = array (
        ...
        'aif'  => array ('type'=>'audio/x-aiff', 'icon'=>'wav'),
        'aiff' => array ('type'=>'audio/x-aiff', 'icon'=>'wav'),
        'aifc' => array ('type'=>'audio/x-aiff', 'icon'=>'wav'),
        'applescript'  => array ('type'=>'text/plain', 'icon'=>'text'),
        'asc'  => array ('type'=>'text/plain', 'icon'=>'flash'),
        'asm'  => array ('type'=>'text/plain', 'icon'=>'text'),
        'au'   => array ('type'=>'audio/au', 'icon'=>'wav'),
        ...
        'm4a'  => array ('type'=>'audio/mp4', 'icon'=>'mpeg'),
